...
exports.default = _vue2.default.extend({
    template: '\n        <div>\n            <canvas width="400" height="300" v-el:canvas></canvas>\n            {{{ legend }}} \n        </div>\n    ',
    ...
    methods: {
        render: function render(data) {
            var chart = new _chart2.default(this.$els.canvas.getContext('2d')).Bar(data);
...
},{"chart.js":1,"vue":3}],5:[function(require,module,exports){
'use strict';
...
var _WinsGraph = require('./components/WinsGraph');

var _WinsGraph2 = _interopRequireDefault(_WinsGraph);
...
new _vue2.default({
    ...
    components: { WinsGraph: _WinsGraph2.default }
});

},{"./components/WinsGraph":5,"vue":3}]},{},[6]);
