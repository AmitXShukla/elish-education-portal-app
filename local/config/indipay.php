...
return [
    ...
    */
    ...
    'testMode'  => env('PAYU_TESTMODE', 'true'),// True for Testing the Gateway [For production false]
    ...
    'payumoney' => [                         // PayUMoney Parameters
        ...
        'successUrl' => env('INDIPAY_SUCCESS_URL', URL_PAYU_PAYMENT_SUCCESS),
        'failureUrl' => env('INDIPAY_FAILURE_URL', URL_PAYU_PAYMENT_CANCEL),
    ],
